...
/*   Updated: 2023/01/10 15:23:12 by kczichow         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*	bit-shifting. The last byte is for transparency and always set to zero.
*/

uint32_t	get_rgba(uint8_t red, uint8_t green, uint8_t blue)
{
	return ((uint32_t)(red << 24 | green << 16 | blue << 8 | 0));
}
